          ...
          <div className={styles.pgs}>
            ...
            <div className={styles.pgs_conference}>
              ...
              <ul className={styles.pgs_link}>
                ...
                <li>
                  <Link href="https://itr-lounge.connpass.com/event/183245/" legacyBehavior>
                    <a target="_blank">
                ...
                <li>
                  <Link href="https://peatix.com/event/1366420/" legacyBehavior>
                    <a target="_blank">
        ...
        {posts.length > 0 ? (
          <div className={styles.service_news}>
            ...
            <div className={styles.service_news_link}>
              <Link href="/posts" legacyBehavior>お知らせ一覧</Link>
            </div>
            <ul className={styles.service_news_items}>
              {posts.map((post, i) => (
                <li key={i}>
                  <span>{post.date}</span>
                  <Link href={`/posts/${encodeURIComponent(post.slug)}`} legacyBehavior>
                    {post.title}
                  </Link>
                </li>
              ))}
