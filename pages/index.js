...
"
                ...
                >
                  <h3>はたわらワイド</h3>
                  <p>「動かないプロジェクトはなぜ生まれるの？」プロジェクト推進専門会社のコパイロツトに聞いた</p>
                </a>
              </SwiperSlide>
              <SwiperSlide className={styles.service_media_contents_item}>
                <a href="https://blog.copilot.jp/entry/news-report-20221121" target="_blank">
                  <h3>fukabori.fm</h3>
                  <p>リモートワークにおけるファシリテーションとProject Sprint</p>
                </a>
              </SwiperSlide>
              <SwiperSlide className={styles.service_media_contents_item}>
