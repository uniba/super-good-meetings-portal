          ...
          <dl>
            ...
            <dd>
              ...
              <dl className={styles.parentheses}>
                ...
                <dt>
                  「運営者ウェブサイト」とは、そのドメインが「https://supergoodmeetings.com」である、運営者が運営するウェブサイト（理由の如何を問わず、運営者のウェブサイトのドメインまたは内容が変更された場合は、当該変更後のウェブサイトを含みます。）を意味します。
                </dt>
                <dt>
                  「登録ユーザー」とは、第3条（登録）に基づいて本サービスの利用者としての登録がなされた個人または法人を意味します。
                </dt>
                <dt>
                  「オーナーユーザー」とは、登録ユーザーのうち当社からプロジェクトのオーナーとして承認された者をいいます。なお、登録ユーザーが法人の場合の当該法人に帰属する個人を含むものとします。登録ユーザーが法人の場合、登録ユーザーに帰属する個人を含むものとします。
                </dt>
                <dt>
                  「一般ユーザー」とは、登録ユーザーのうちオーナーユーザー以外の者をいいます。なお、登録ユーザーが法人の場合の当該法人に帰属する個人を含むものとします。登録ユーザーが法人の場合、登録ユーザーに帰属する個人を含むものとします。
                </dt>
                <dt>
                ...
                <dt>
                  「有料プラン」とは、本サービスに関し登録ユーザーが月額の利用料金を支払って利用するプランをいいます。有料プランの内容、第6条に定める利用料金及び有効期間等の詳細は運営者が別途定め、登録ユーザーに通知するところに従うものとします。
                </dt>
              </dl>
            </dd>
            <dt>第3条（登録）</dt>
            ...
            <dt>第5条（パスワード及びユーザーIDの管理）</dt>
            <dd>
              <dl>
                <dd>
                  登録ユーザーは、自己の責任において、本サービスに関するパスワード及びユーザーIDを適切に管理及び保管するものとし、これを第三者に利用させ、または貸与、譲渡、名義変更、売買等をしてはならないものとします。なお、登録ユーザーが法人の場合、登録ユーザーは、オーナーユーザー及び一般ユーザーをして本利用規約に基づき登録ユーザーが負う義務を理解させ、これを遵守させるものとします。なお、登録ユーザーが法人の場合、オーナーユーザー及び一般ユーザーをして、本利用規約に基づき登録ユーザーが負う義務を理解させ、これを遵守させるものとします。
                </dd>
                <dd>
            ...
            <dd>
              <dl>
                <dd>
                  登録ユーザーは、本サービス利用の対価として、別途運営者が定め、運営者ウェブサイトに表示する利用料金（有料プランの利用料金を含みますが、運営者が有料オプション等を追加する場合はこれらを含むものとします。以下同じ。）を、運営者が指定する支払方法により運営者に支払うものとします。
                </dd>
                <dd>
                  登録ユーザーが利用料金の支払を遅滞した場合、登録ユーザーは年3％の割合による遅延損害金を運営者に支払うものとします。
                </dd>
              </dl>
            </dd>
            <dt>第7条（禁止事項）</dt>
            ...
            <dd>
              <dl>
                ...
                <dd>
                  登録ユーザーが有料プランを利用している場合、登録ユーザーは有料プランのみを中途解約することができます。この場合、登録ユーザーは、当該有料プランの有効期限が満了するまで（以下「猶予期間」といいます。）は引き続き当該有料プランを利用することができ、その後も有料プラン以外の機能につき、本サービスを継続的にご利用いただけます。
                </dd>
                <dd>
                  前項の場合、当該有料プランにかかる利用料金につき、当社は返金を一切要しないものとします。
                  予めご了承ください。なお、猶予期間中は当該中途解約を取り消すことはできますが、他の有料プランへの変更はできません。
                </dd>
              </dl>
            </dd>
            <dt>第12条（本サービスの内容の変更、終了）</dt>
            <dd>
              <dl>
                <dd>
            ...
            <dd>
              <dl>
                <dd>
                  運営者は、その裁量において本規約を変更できるものとします。運営者は、本規約を変更する場合、運営者所定の方法によりした場合には、登録ユーザーに事前に変更の効力発生日及びその内容を周知するものとし、効力発生日の到来をもって本規約は変更され、登録ユーザと運営者の法律関係に適用されるものとします。
                </dd>
                <dd>
